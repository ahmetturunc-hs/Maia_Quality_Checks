...
This rubric must be focused, not exhaustive. Produce 30–45 criteria total, targeting 38–45. Aim for the higher end of the range. A rubric with 40+ criteria gives the judge more independent signals and reduces the impact of any single noisy criterion. Every criterion must still earn its place by testing something that a model could realistically get wrong and that matters for the quality of the deliverable.
...
The narrow exception: low-stakes stylistic instructions (use bold headers, apply consistent number formatting, use light grey fills, hide gridlines) may be omitted if you have already hit the upper item limit and need to trim. But substantive content requirements (sections, sheets, deliverables, calculations, named entities) must always be covered.
...
- The rubric has between 30 and 45 criteria total, targeting 38-45
